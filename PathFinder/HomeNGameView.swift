                        ...
                        NavigationLink(destination: CrystalBallView()) {
                            ZStack {
                                ...
                                Circle()
                                    ...
                                    .scaleEffect(pulse ? 1.1 : 1.0) // scala più contenuta
                            ...
                            .frame(width: 170, height: 170)
                            .clipShape(Circle()) // ✅ mantiene tutto centrato e confinato
                        }
                        .padding(.top, 56)
                        .onAppear {
                            pulse = true
